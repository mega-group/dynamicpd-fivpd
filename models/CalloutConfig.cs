...
namespace dynamicpd.models
{
    public class CalloutConfig
    {
        ...
        public bool CFGGen { get; set; } = false; // Internal to easily generate config files if needed
        public bool printToConsole { get; set; } = false; // allow logging to server console for minimal information
        public bool debugToConsole { get; set; } = false; // allow logging of debug information to server console for callout developers without having to use client console
